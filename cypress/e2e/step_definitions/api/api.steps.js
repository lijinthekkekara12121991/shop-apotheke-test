...
Given('I send a request with valid credentials', (time) => {
    cy.request({
        method: 'POST',
...
Given('I send a request with some missing credentials', (time) => {
    cy.request({
        method: 'POST',
        url: Cypress.env('API_URL') + '/auth/v2/at/login',
        headers: {
...
Given('I send a request with invalid credentials', (time) => {
    cy.request({
        method: 'POST',
        url: Cypress.env('API_URL') + '/auth/v2/at/login',
        headers: {
